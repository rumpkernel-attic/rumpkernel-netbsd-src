...
#ifndef RUMP_SYS_RENAME__SCHED_SETAFFINITY
#define RUMP_SYS_RENAME__SCHED_SETAFFINITY rump___sysimpl__sched_setaffinity
#endif
...
#ifndef RUMP_SYS_RENAME__SCHED_GETAFFINITY
#define RUMP_SYS_RENAME__SCHED_GETAFFINITY rump___sysimpl__sched_getaffinity
#endif
...
int rump_sys__sched_setaffinity(pid_t, lwpid_t, size_t, const cpuset_t *) __RENAME(RUMP_SYS_RENAME__SCHED_SETAFFINITY);
int rump_sys__sched_getaffinity(pid_t, lwpid_t, size_t, cpuset_t *) __RENAME(RUMP_SYS_RENAME__SCHED_GETAFFINITY);
